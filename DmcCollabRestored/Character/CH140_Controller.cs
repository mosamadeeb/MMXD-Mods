...
namespace DmcCollabRestored.Character
{
    public class CH140_Controller : CharacterControlBase, ITangerineLogicUpdate
    {
        ...
        private void PlayFrenzyFx()
        {
            ...
            Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.FX_2_00, this._refEntity.ModelTransform.position, OrangeCharacter.NormalQuaternion);
        ...
        public override void PlayerReleaseSkillCharacterCall(int id)
        {
            ...
            if (id == 0)
            {
                ...
                Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.FX_0_01, this._refEntity.ModelTransform.position, OrangeCharacter.NormalQuaternion);
                base.PlayVoiceSE("v_xc_skill01");
                    ...
                    switch (curSubStatus)
                    {
                        ...
                        case OrangeCharacter.SubStatus.SKILL0_1:
                            if (this.nowFrame >= this.endFrame)
                            {
                                ...
                                this.shootDirection = this._refEntity.ShootDirection;
                                int num2 = this.SKL0_3_TRIGGER - this.SKL0_2_TRIGGER;
                                int num3 = this.SKL0_END - this.SKL0_2_TRIGGER;
                                this.isSkillEventEnd = false;
                                ManagedSingleton<CharacterControlHelper>.Instance.ChangeToNextStatus(this._refEntity, num2, num3, OrangeCharacter.SubStatus.SKILL0_2, out this.skillEventFrame, out this.endFrame);
                                return;
                            }
                            break;
                        ...
                        default:
                            ...
                            else
                            {
                                ...
                                if (!this.isSkillEventEnd && this.nowFrame >= this.skillEventFrame)
                                {
                                    ...
                                    Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.FX_1_01, this._refEntity.ModelTransform.position, OrangeCharacter.NormalQuaternion);
        ...
        public void SetStatusCharacterDepend(OrangeCharacter.MainStatus mainStatus, OrangeCharacter.SubStatus subStatus)
        {
            if (mainStatus != OrangeCharacter.MainStatus.TELEPORT_OUT)
            {
                ...
                {
                    Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.FX_0_00, this._refEntity.ModelTransform, Quaternion.identity);
                    return;
                }
            }
            else
        ...
        public void ChangeComboSkillEvent(Il2CppReferenceArray<Il2CppSystem.Object> parameters)
        {
            ...
            bool flag = parameters[0].Unbox<int>() != 0;
            int num = parameters[1].Unbox<int>();
        ...
        {
            return new Il2CppStringArray(new string[] { "ch140_skill_01_phase1_start", "ch140_skill_01_phase1_loop", "ch140_skill_01_phase1_jump_end", "ch140_skill_01_phase2_stand", "ch140_skill_01_phase2_jump", "ch140_skill_02_jump_start", "ch140_skill_02_jump_loop", "ch140_skill_02_jump_end" });
        }

        public override Il2CppStringArray GetCharacterDependBlendAnimations()
        {
            return new Il2CppStringArray(new string[] { "ch140_skill_01_phase1_start", "ch140_skill_01_phase1_loop" });
        }
