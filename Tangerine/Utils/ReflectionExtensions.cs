...
namespace Tangerine.Utils
{
    public static class ReflectionExtensions
    {
        ...
        {
            Il2CppSystem.Reflection.MethodInfo method = target?.GetIl2CppType()?.GetMethod(methodName, ReflectionExtensions.all);
            if (method != null)
            {
        ...
        {
            Type sysType = ReflectionExtensions.GetActualType(obj);
